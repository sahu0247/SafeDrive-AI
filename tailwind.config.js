    ...
    theme: {
        ...
        extend: {
            ...
            keyframes: {
                ...
                'pulse-glow': {
                    '0%, 100%': { boxShadow: '0 0 8px rgba(0,255,153,0.4)' },
                    '50%': { boxShadow: '0 0 24px rgba(0,255,153,0.8)' }
                },
                'pulse-danger': {
                    '0%, 100%': { boxShadow: '0 0 8px rgba(255,59,48,0.6)', opacity: '1' },
                    '50%': { boxShadow: '0 0 24px rgba(255,59,48,1)', opacity: '0.7' }
                },
                'scan-line': {
